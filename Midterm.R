...
data$H1TO15<-car::recode(data$H1TO15,"'(1) Every day/almost every day'=6")
data$H1TO15<-car::recode(data$H1TO15,"'(2) 3-5 days/week'=5")
data$H1TO15<-car::recode(data$H1TO15,"'(3) 1 or 2 days/week'=4")
data$H1TO15<-car::recode(data$H1TO15,"'(4) 2 or 3 days/month'=3")
data$H1TO15<-car::recode(data$H1TO15,"'(5) Once a month or less (3-12 times in past 12 months)'=2")
data$H1TO15<-car::recode(data$H1TO15,"'(6) 1 or 2 days in past 12 months'=1")
data$H1TO15<-car::recode(data$H1TO15,"'(7) Never (skip to Q.29)'=0")
data$H1TO15[data$H1TO15=="(97) Legitimate skip (hasn't had a drink)"] <- NA #defining this value as NA so that the missing data can be accounted for later.
...
#repeating the above
data$alcoholUse <- as.numeric(data$alcoholUse)
